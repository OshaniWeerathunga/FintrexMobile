...
public final class FragmentInboxBinding implements ViewBinding {
  ...
  private FragmentInboxBinding(@NonNull FrameLayout rootView, @NonNull RecyclerView inboxrecycler) {
    this.rootView = rootView;
    this.inboxrecycler = inboxrecycler;
  }
  ...
  public static FragmentInboxBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.inboxrecycler;
      RecyclerView inboxrecycler = rootView.findViewById(id);
      if (inboxrecycler == null) {
        break missingId;
      }

      return new FragmentInboxBinding((FrameLayout) rootView, inboxrecycler);
    }
