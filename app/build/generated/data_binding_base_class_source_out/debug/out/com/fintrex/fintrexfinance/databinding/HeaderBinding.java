...
public final class HeaderBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView headerNic;

  private HeaderBinding(@NonNull ConstraintLayout rootView, @NonNull TextView headerNic) {
    this.rootView = rootView;
    this.headerNic = headerNic;
  }
  ...
  public static HeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.headerNic;
      TextView headerNic = rootView.findViewById(id);
      if (headerNic == null) {
        break missingId;
      }

      return new HeaderBinding((ConstraintLayout) rootView, headerNic);
    }
