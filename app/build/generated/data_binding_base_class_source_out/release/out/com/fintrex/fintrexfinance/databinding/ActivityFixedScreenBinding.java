...
public final class ActivityFixedScreenBinding implements ViewBinding {
  ...
  @NonNull
  public static ActivityFixedScreenBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityFixedScreenBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_fixed_screen, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityFixedScreenBinding bind(@NonNull View rootView) {
